...
class MetaboGraph:
    ...
    def __init__(self, config: MetaboConfig, logger: MetaboLogger, event_bus: MetaboEventBus):
        ...
        self.logger.info("Initialized new MetaboGraph")
    ...
    def add_node(self, node: MetaboNode) -> str:
        ...
        if node.layer in self.hierarchies:
            ...
            self.logger.warning(f"Unknown layer type '{node.layer}' for node {node.id}")
    ...
    def add_relation(self, relation: MetaboRelation) -> str:
        ...
        if relation.source_id not in self.graph:
            self.logger.warning(f"Source node {relation.source_id} does not exist. Relation not added.")
            return None
        
        if relation.target_id not in self.graph:
            self.logger.warning(f"Target node {relation.target_id} does not exist. Relation not added.")
            return None
    ...
    def remove_node(self, node_id: str) -> bool:
        ...
        if node_id not in self.graph:
            self.logger.warning(f"Node {node_id} does not exist. Cannot remove.")
            return False
    ...
    def remove_relation(self, rel_id: str) -> bool:
        ...
        if rel_id not in self._relation_lookup:
            self.logger.warning(f"Relation {rel_id} does not exist. Cannot remove.")
            return False
        ...
        self.logger.debug(f"Removed relation: {rel_id}")
        return True
    ...
    def save_to_file(self, filepath: str) -> None:
        ...
        try:
            ...
            self.logger.info(f"Graph successfully saved to {filepath}")
            return True
            
        except Exception as e:
            self.logger.error(f"Error saving graph to file: {e}")
            return False
    ...
    def load_from_file(self, filepath: str) -> None:
        ...
        try:
            ...
            self.logger.info(f"Graph successfully loaded from {filepath}")
            return True
            
        except Exception as e:
            self.logger.error(f"Error loading graph from file: {e}")
            return False
        ...
        try:
            ...
            for i in range(len(path_nodes) - 1):
                ...
                if relations:
                    ...
                    self.logger.warning(f"No relation found between {node_id} and {next_node_id}")
            ...
            self.logger.info(f"No path found between {source_id} and {target_id}")
            return []
    ...
    def export_to_json(self, filepath: str) -> bool:
        ...
        try:
            ...
            self.logger.info(f"Graph successfully exported to JSON: {filepath}")
            return True
            
        except Exception as e:
            self.logger.error(f"Error exporting graph to JSON: {e}")
            return False
    ...
    def import_from_json(self, filepath: str) -> bool:
        ...
        try:
            ...
            self.logger.info(f"Graph successfully imported from JSON: {filepath}")
            return True
            
        except Exception as e:
            self.logger.error(f"Error importing graph from JSON: {e}")
            return False
